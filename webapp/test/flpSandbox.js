		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tpldeliveries-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tpldeliveries-display": {
								"semanticObject": "tpldeliveries",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tpl.deliveries",
									"url": sap.ui.require.toUrl("tpl/deliveries")
								}
							}
						}
					}
